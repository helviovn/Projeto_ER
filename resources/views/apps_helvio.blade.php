        ...
        <div class="container">
            <div class="row" style="column-gap: 40px">
                ...
                <div class="col-2" style="margin-left: -6%">
                    <br>
                    <a href="/contactos1"><img class="radios" src="img/contactos.png"  alt="" style="display: block; margin-left: auto; width: 50%; margin-right: auto"></a>
                ...
                <div class="col-2">
                    ...
                    <br><br>
                    <a href="/nav"> <img class="radios" src="img/gpsapple.png" alt="" style="display: block; margin-left: auto; width: 40%; margin-right: auto"></img></a>
                    <h3 style="text-align: center">Navegação</h3>
                    <br><br>
                    <img class="radioss" src="img/minecraft.png" alt="" style="display: block; margin-left: auto; margin-top: 10%; width: 40%; margin-right: auto"></img>
                    <h3 style="text-align: center">Minecraft</h3>
                </div>
                <div class="col-2">
                    <br>
                    <img class="radioss" src="img/twitter.png" alt="" style="display: block; margin-left: auto; width: 50%; margin-right: auto"></img>
                    <h3 style="text-align: center">Twitter</h3>
                    <br><br>
                    <img class="radioss" src="img/discord.png" alt="" style="display: block; margin-left: auto; width: 40%; margin-right: auto"></img>
                    <h3 style="text-align: center">Discord</h3>
                    <br>
                    <img class="radioss" src="img/youtube.png" alt="" style="display: block; margin-left: auto; margin-top: 5%; width: 100%; margin-right: auto"></img>
